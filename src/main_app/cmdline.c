/*
  ...
  gengetopt --input=./wrapper.ggo --output-dir=/tmp/build/generated/gengetopt --c-extension=c --header-extension=h
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -H, --host=STRING       The host address to bind to (default=`127.0.0.1')",
  "  -D, --decrypt-port=INT  The port for the decryption service (default=`10020')",
  "  -M, --m3u8-port=INT     The port for the M3U8 service (default=`20020')",
  "  -P, --proxy=STRING      The proxy server to use (e.g., http://host:port)\n                            (default=`')",
  "  -L, --login=STRING      Apple Music credentials",
  "  -F, --code-from-file    Read 2FA code from /data/2fa.txt instead of stdin\n                            (default=off)",
    0
};
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'H':	/* The host address to bind to.  */
          ...
          break;
        case 'D':	/* The port for the decryption service.  */
          ...
          break;
        case 'M':	/* The port for the M3U8 service.  */
          ...
          break;
        case 'P':	/* The proxy server to use (e.g., http://host:port).  */
          ...
          break;
        case 'L':	/* Apple Music credentials.  */
          ...
          break;
        case 'F':	/* Read 2FA code from /data/2fa.txt instead of stdin.  */
  ...
  if (check_required)
    {
      error_occurred += cmdline_parser_required (args_info, argv[0]);
    }
